...
module.exports = function propertySteps() {
     ...
     */
    this.Given(/^I set property (.+) to (.+)$/, function(propertyString, valueString, done) {
     ...
     */
    this.Given(/^I check property (.+) equals (.+)$/, function(propertyString, valueString, done) {
     ...
     */
    this.Given(/^I check property (.+) has type (\S+)$/, function(propertyString, expected, done) {
