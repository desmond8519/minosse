...
module.exports = function propertySteps() {
    ...
    /**
     * [DEPRECATED] Load an object from a `.json` file and save it on the world.
    ...
    /**
     * [DEPRECATED] Assign the value of one property to another property.
     */
    ...
    /**
     * [DEPRECATED] Set a property with a random unique id
     */
    this.Given(/^I set property (.+) with a unique id$/, function (propertyString, done) {
